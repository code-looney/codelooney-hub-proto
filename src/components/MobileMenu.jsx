                        ...
                        <React.Fragment key={route.id}>
                            <li className={`border-b rounded-xl hover:bg-[#00df9a] duration-300 hover:text-black cursor-pointer border-gray-600
                                ...
                                <NavLink
                                    ...
                                    to={route.path} // Make sure 'route.path' is defined
                            ...
                            {route.page === "Coaching" && context.dropdownOpen === route.id && (
                                <Transition
                                    show={context.dropdownOpen === route.id}
                                ...
                                >
                                    <div className="border-b border-gray-600">
                                        <NavLink
                                            ...
                                            className="block border border-gray-600 rounded-xl p-4 ml-5 text-[.8rem] font-barlowCondensed hover:bg-[#00df9a] hover:text-black duration-300"
                                        >
                                            1 To 1 Call
                                        </NavLink>
                                    </div>
