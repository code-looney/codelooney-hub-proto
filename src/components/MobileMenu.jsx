...
const MobileMenu = () => {
    ...
    return (
        ...
        >
            <div className={`fixed right-0 py-7 top-0 w-[50%] h-full border-l border-l-gray-900 bg-[#0000001f] ease-in-out duration-500
                ...
                <ul className='transition duration-300 ease-in-out'>
                    ...
                    {context.router && context.router.map(route => (
                            <React.Fragment key={route.id}>
                                ...
                                {route.page === "Coaching" && (
                                    <li className={`${context.dropdownOpen} rounded-xl text-white`}>
                                        <Transition
                                        ...
                                        >
                                            <div className="ml-5 ">
                                                <NavLink
                                                    ...
                                                    className="block border border-gray-600 rounded-xl p-4 text-[14px] font-barlowCondensed hover:bg-[#00df9a] hover:text-black duration-300 w-fullr"
                                                >
                                                    1 To 1 Call
                                                </NavLink>
                                            </div>
