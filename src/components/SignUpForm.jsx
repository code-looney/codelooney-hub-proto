...
const SignUpForm = () => {
    ...
    useEffect(() => {
        if (context.open) {
            // Delay button fade-in when modal is opened
            const timer = setTimeout(() => setShowButton(true), 300); // Adjust delay as needed
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-70 flex items-center justify-center transition-opacity duration-500 ease-out">
        ...
        <div className="relative z-10 w-[420px] h-[420px] p-8 bg-gradient-to-br from-black to-gray-800 border border-green-700 rounded-lg shadow-xl transform transition-transform duration-500 ease-in-out scale-100 hover:scale-105">
            ...
            <div className="flex flex-col h-full justify-center items-center">
                ...
                <div className="mt-4 flex gap-2 items-center">
                    ...
                    >
                        <svg className="w-8 h-8 text-green-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1 17h-2v-2h2v2zm0-4h-2V7h2v8z"/></svg>
                    </button>
        ...
        return (
                ...
                <form onSubmit={handleSubmit}  className="h-full flex flex-col justify-center  ">
                    <label htmlFor="email" className="text-2xl font-semibold mb-4 text-center uppercase">Register today!</label>
                    ...
                    <div className="mb-4 flex flex-col gap-1">
                        <label htmlFor="option" className="block text-gray-700">Select your area of ​​interest:</label>
                        <select
                        id="option"
                        type="option"
                        name="option"
                    ...
                    <button type="submit" disabled={state.submitting} className="w-full bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600">Submit</button>
            </form>
                    </div>
                </div>
            </Transition>
